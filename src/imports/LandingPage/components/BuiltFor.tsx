...
export default function BuiltFor() {
  ...
  return (
    <div id="faqs" className="bg-white relative rounded-[28px] shrink-0 w-full max-w-[1248px] p-[16px] sm:p-[32px] z-10 border border-[#d4d5d8] shadow-sm scroll-mt-6" data-name="built for">
